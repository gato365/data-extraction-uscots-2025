...
## 1. Goals & Objectives (Entire workshop)
...
![New vs Old](images/new_old_ways.jpeg){fig-align="center" width="406"}
...
### P4. Static and Dynamic Sources of Data Extraction
...
iowa_income_df %>%
  ...
  labs(
    title = "Top 10 Iowa Counteis by Median House Income in 2022",
    x = "Median House hold Income",
    y = "County"
  ) +
  theme_minimal()
```
...
iowa_wiki_df <- htmltab(doc = url, which = 2)
...
Now that we have the correct table, let's explore it with `glimpse()` to
