...
- Task 4. ____ Use the `filter()` function to select only the rows where the `Season` column is equal to "season_1".
...
###### Q2.
What conclusion could be made about this plot (chatgpt)
...
Note 3:
(TODOs: Make this into a P and Note)
