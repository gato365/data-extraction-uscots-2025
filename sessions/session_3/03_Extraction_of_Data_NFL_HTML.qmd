...
-   This pointer references the structure of the web page in memory, but
    doesn't display actual text or data.
...
-   Scrape sports statistics from a reliable table:
    ...
    -   Example: Wikipedia table of Olympic medal counts or NBA season
        stats
...
5.  Practice: Going back and forth between R and browser to inspect
    structure
