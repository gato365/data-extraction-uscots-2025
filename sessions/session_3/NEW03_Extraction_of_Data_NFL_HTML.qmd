...
2.  **`remove_empty()`** gets rid of empty rows or columns. `r     # The third row is empty, so it gets removed     remove_empty(cleaned_data, which = "rows")     #> # A tibble: 2 × 3     #>   first_name last_name age     #>   <chr>      <chr>     <chr>     #> 1 gandalf    the grey  2019     #> 2 frodo      baggins   50`
...
![](images/html_page_face.png){fig-align="center" width="578"}
...
### Psub_2: html_text (need to change gif)

### Psub_3: html\_\* (need something)
