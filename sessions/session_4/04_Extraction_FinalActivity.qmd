...
In this capstone session, we will combine our API and web scraping skills to complete two mini-projects. Each project will involve writing a custom function to extract data and then using that function to create a unique data visualization.
