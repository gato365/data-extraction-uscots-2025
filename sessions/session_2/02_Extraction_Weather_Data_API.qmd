...
(TODO: Change the based on concept Foundation)
...
Q2. Matching
You might show this flow visually and say:
...
![GATO365 Anatomy JSON](images/Anatomy of a JSON Response.gif)
...
###### P8. Requests, URLs & Queries



-  so what we’re going to first do is create our response and the most ideal way.
...
###### P9: What Happens Under the Hood
...
###### P10: Two Ways to Build Request Objects
...
Explain the function and fill in blanks
Emphasize  error handling

###### P11. Lets try out this new function on the city
...
###### P12. Lets Look at multtiple cities using the the map_df fucntion within the purrr package 
...
Note 23:
Explain need for lubridate
Emphasize the new endpoint (`https://api.openweathermap.org/data/3.0/onecall/day_summary?`) an how it is a paid subscription
...
###### P14. There are alot of ways of doing this, I decided not to use for loop in R
...
###### P16. **Run for a Single City (e.g., “Atlanta”)**
...
###### P17. **Run for a Vector of Cities Using `purrr::map_dfr()`**
...
(TODO: Highlight ENdpoint: `https://api.openweathermap.org/data/2.5/forecast?`)
...
###### P19. Try for city notice the number of rows and columns
```{r}
get_city_forecast_5day("Atlanta")
```


###### P20. Lets Look at multiple cities 
